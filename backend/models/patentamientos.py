...
class Patentamiento(Base, TimestampMixin):
    ...
    provincia = Column(String(100), nullable=True)  # Provincia o registro seccional (DNRPA)

    # Métricas
    cantidad = Column(Integer, nullable=False)

    # Metadata
    fuente = Column(String(50), nullable=False, default="ACARA")  # 'ACARA', 'FACCARA', 'DNRPA'
